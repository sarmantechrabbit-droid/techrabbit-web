      ...
      {confetti.map(item => (
        <motion.div
          ...
          style={{
            left: `${item.left}%`,
            top: '-10px',
            background: ['var(--color-brand-blue)', 'var(--color-brand-green)', '#fbbf24'][Math.floor(Math.random() * 3)]
          }}
          animate={{
            y: 400,
            opacity: [1, 1, 0],
...
export default function SuccessMessage({ onReset }) {
  return (
    ...
    >
      ...
      >
        We've received your request and our team will be in touch within 4 business hours.
      </motion.p>
