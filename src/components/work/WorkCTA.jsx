...
export default function WorkCTA() {
  return (
    <section className="relative overflow-hidden bg-[var(--color-bg-page)] px-4 pb-12 sm:px-6 md:px-8 lg:px-12">
      <div
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <Reveal>
          <motion.div
            ...
            viewport={{ once: true }}
            className="relative rounded-3xl border overflow-hidden p-6 sm:p-8 md:p-10 lg:p-12"
            style={{
          ...
          >
            ...
            <motion.div
              ...
              style={{
                background:
                  "radial-gradient(circle, rgba(42,171,215,0.1) 0%, transparent 70%)",
              }}
            />
            ...
            <div className="relative z-10">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                <div>
                  ...
                  <h2 className="mb-4 max-w-[12ch] text-3xl md:text-4xl font-bold font-heading tracking-tight text-[var(--color-text-primary)] leading-[1.15]">
                    Let's bring your
                    <br />
                    <span
                  ...
                  <p className="text-[var(--color-text-body)] text-sm sm:text-base leading-relaxed mb-6 font-medium">
                    Whether you need a pre-built solution or a custom platform,
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    ...
                    {/* <Link
                      to="/#pricing"
                      className="flex w-full sm:w-auto items-center justify-center gap-2 px-8 py-4 rounded-full border border-[var(--color-border-subtle)] bg-white text-[var(--color-text-primary)] font-black text-sm hover:bg-[var(--color-bg-card-light)] transition-all duration-300"
                    >
                      View Pricing
                      <ArrowRight className="w-4 h-4" />
                    </Link> */}
